...
<section class="parallax-gallery overflow-hidden">
    <div class="grid-container grid-x grid-margin-x gs--parallax-container">
        <div class="text-container cell medium-6 scroll-track-center">
