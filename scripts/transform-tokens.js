 ...
 * Produces one @media block per breakpoint, each containing a :root rule with
 * CSS custom properties derived from the breakpoints/* token groups.
 *
...
function generateBreakpointCustomProperties(allTokensRoot) {
  ...
  for (const breakpoint of BREAKPOINTS) {
    ...
    const tokens = extractBreakpointTokens(tokenGroup, [], allTokensRoot);
