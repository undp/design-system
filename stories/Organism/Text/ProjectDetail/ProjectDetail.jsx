...
export const Projectdetail = ({
  ...
  return (
    ...
    <div className="projectdata-section left-right grid-x grid-margin-x">
      ...
      <div className="cell large-3 medium-2 projectdata-section__wrapper2">
        <Projectcolumn headertext={title4} subtext={subtitle4} />
      </div>

      <div className="cell large-4 medium-5 projectdata-section__wrapper3">
        <div className="grid-x">
          <div className="cell large-5 medium-7 small-6 projectdata-section__wrapper3--cart-1">
            <Projectcolumn headertext={title5} subtext={subtitle5} />
          </div>
          <div className="cell large-7 medium-5 small-6 projectdata-section__wrapper3--cart-2">
