...
- Custom JS file **(accordion.js)** is located in the same js folder.
- Take HTML from the HTML tab in the canvas

- To use SCSS include the following files in your implementation
- Include the common SCSS files like breakpoints, variables from **(accordion.js)**
- Component SCSS file: **footer.scss**
- To use CSS include the following files in your implementation
- The compiled CSS file from **assets/css/style.css**
