  ...
  switch (locale) {
    case "english":
      const engText = {
        ...
        headerText: "United Nations",
        headerText2: "Development Programme",
    ...
    case "arabic":
      const arabicText = {
        ...
        headerText: "الأمم المتحدة",
        headerText2: "برنامج التطوير",
    ...
    case "burmese":
      const burmeseText = {
        ...
        headerText: "ကုလသမဂ္ဂ",
        headerText2: "ဖွံ့ဖြိုးရေးအစီအစဉ်",
  ...
  {(args, { globals: { locale } }) => {
    ...
    return (
      <Footer
        ...
        headerText2={caption.headerText2}
        alt={"UNDP Logo"}
        element="input"
        type="email"
        required="required"
