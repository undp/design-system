...
export const Homepagehero = ({ title, content, button, variant, ...args }) => {
  useEffect(() => {
    viewport('.hero__title');
    viewport('.hero__subtitle');
  }, [])
  return (
    <div className='hero__wrapper'>
      {variant === 'video' ?
        ...
        :
        <div className="hero__background overlay-grey">
          <img src={BackgroundImg} alt={BackgroundImg} />
        </div>}
      <div className="hero__container">
        <div className="grid-x">
          <div className="cell large-7 medium-9 hero__content"  id ="header">
            <Heading type='1' className='hero__title color-white left-right' label={title}/>
            <Heading type='4' className='hero__subtitle color-white left-right' label={content} />
