...
OurExpertiseStory.args = {
};

OurExpertiseStory.parameters = {
  docs: {
    description: {
      component: `
...
- Initialize the slider in document ready or window load by calling ourExpertise() function.
...
- https://cdn.jsdelivr.net/npm/@undp/design-system/docs/js/components/our-expertise.min.js
