...
The UNDP Design System supports the following languages by default, using the Proxima Nova, [Söhne Breit](https://klim.co.nz/retail-fonts/soehne-breit/) and [UNBangla](https://www.undp.org/bangladesh/publications/un-bangla-font) fonts:
1. Latin based languages (i.e. English, French, Spanish, etc)
2. Cyrillic languages (i.e. Ukrainian, Macedonian)
3. Bengali

For additional language support, the [Noto Sans](https://fonts.google.com/noto/specimen/Noto+Sans) font family can be used for the following languages,
