  ...
  <div className="grid-container">
    ...
    <div className="grid-x grid-margin-x content">
      <div className="cell">
        ...
        <p>
          {`If you'd like to contribute code, fork the repository and create a pull request against the `}<code>master</code>{` branch. Make sure to follow our existing component structure and include documentation and accessibility considerations.`}
        </p>
        <hr />
        <p>
          <strong>
