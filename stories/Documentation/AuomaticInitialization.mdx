...
<Meta title="Getting started/Automatic Component Initialization" />
...
Add the component initializer script to your HTML after including the component-specific JS files (and any component dependencies):
...
<script
  src="https://cdn.jsdelivr.net/npm/@undp/design-system-assets/js/init.js"
  defer
></script>
```

Some legacy components may still require third-party libraries during the migration away from jQuery. Check each component's documentation page for the exact dependencies.
...
<ul
  class="accordion"
  data-undpds-component="accordion"
...
<header
  ...
  data-undpds-component="country-header"
  data-overflow="true"
>
...
<ul class="accordion" aria-label="accordion" data-undpds-component="accordion">
  <li>
    <button tabindex="0" aria-expanded="false">Section Header</button>
    <div class="accordion__panel" aria-hidden="true" role="region">
      <p>Panel content goes here</p>
    </div>
  </li>
  <li>
    <button tabindex="0" aria-expanded="false">Another Section</button>
    <div class="accordion__panel" aria-hidden="true" role="region">
