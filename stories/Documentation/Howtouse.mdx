...
- jQuery [(https://www.jquery.com/)](https://www.jquery.com/) for legacy components still migrating to vanilla JavaScript
...
- All the Icons can be found in the **_docs/images_** directory.
