...
<Meta title="Molecules/Navbar" parameters={{
    backgrounds: {
      default: "white",
...
<Story name="Breadcrumb-link">
  {(args, { globals: { locale } }) => {
    const caption = getCaptionForLocale(locale);
    return <Breadcrumbcomponent data={caption} active={'Default'} ></Breadcrumbcomponent>;
  }}
</Story>

<div className="subheading">Breadcrumb white</div>

<Story name="Breadcrumb-link white" parameters={{ backgrounds: { default: "gray" } }}>
  {(args, { globals: { locale } }) => {
    const caption = getCaptionForLocale(locale);
    return <Breadcrumbcomponent data={caption} active={'white'} ></Breadcrumbcomponent>;
  }}
</Story>
