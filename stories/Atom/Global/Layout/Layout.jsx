...
export const Layout = ({ }) => {
  return (
    <div>
		...
		<div className="grid_name">Collapse Cells <span>X Grid only</span></div>
		<div className="grid_description">
		...
		<div class="grid-x grid-margin-x">
				<div class="cell small-4 large-offset-2 grid--layout">
					<div className="column"> Offset 2 on large</div>
				</div>
				<div class="cell small-4 grid--layout">
					<div className="column"> 4 cells </div>
				</div>
		</div>
		<div className="grid_name">Block Grids <span>X Grid only</span></div>
		<div className="grid_description">
