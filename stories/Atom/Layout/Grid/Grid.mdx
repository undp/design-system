...
# Grid system
A grid is a series of rows where the developer specifies the content. This Design system is based on Foundation Grid, more you can find about grid system here [https://get.foundation/sites/docs/xy-grid.html](https://get.foundation/sites/docs/xy-grid.html)
...
- [https://cdn.jsdelivr.net/npm/@undp/design-system-assets/css/base-minimal.min.css](https://cdn.jsdelivr.net/npm/@undp/design-system-assets/css/base-minimal.min.css)
