...
You need to include **[https://cdn.jsdelivr.net/npm/@undp/design-system-assets/css/base-minimal.min.css](https://cdn.jsdelivr.net/npm/@undp/design-system-assets/css/base-minimal.min.css)** in your html file and you are good to go.