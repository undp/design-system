...
<ul>
  <li>
    We can use the <code>h1/h2/h3/h4/h5/h6 tag</code> in any component to
    display the headings. h1 for most important heading to h6 for least
    important heading.
  </li>
</ul>
...
<ul>
  ...
  <li>
    Component SCSS file:<code>typography.scss</code>
  </li>
...
<ul>
  <li>
    We can use the <code>abbr tag</code> in any component, to display as a
    tooltip when you hover over the element.
  </li>
</ul>
...
<ul>
  ...
  <li>
    Component SCSS file:<code>abbr.scss</code>
  </li>
  <u>To use CSS include the following files in your implementation</u>
  <li>
    The compiled CSS file from <code>assets/css/style.css</code>
...
<ul>
  <li>
    We can use <code>cite</code> in any component to render the text found
    within the <code>cite tag</code>.
  </li>
</ul>
...
<ul>
  ...
  <li>
    Component SCSS file:<code>cite.scss</code>
  </li>
  <u>To use CSS include the following files in your implementation</u>
  <li>
    The compiled CSS file from <code>assets/css/style.css</code>
...
<ul>
  <li>
    We can use the <code>code</code> in any component to render the text found
    within the <code>code tag</code> in monospace font.
  </li>
</ul>
...
<ul>
  ...
  <li>
    Component SCSS file:<code>code.scss</code>
  </li>
  <u>To use CSS include the following files in your implementation</u>
  <li>
    The compiled CSS file from <code>assets/css/style.css</code>
...
<ul>
  <li>
    We can use the <code>hr tag</code> in any component to display the
    horizontal break.
  </li>
</ul>
...
<ul>
  <li>
    We can use the <code>mark</code> in any component to render the text found
    within the <code>mark tag</code> as text with a light yellow background
    color.
  </li>
</ul>
...
<ul>
  ...
  <li>
    Component SCSS file:<code>mark.scss</code>
  </li>
  <u>To use CSS include the following files in your implementation</u>
  <li>
    The compiled CSS file from <code>assets/css/style.css</code>
...
<ul>
  <li>
    We can use the <code>q</code> in any component to render quotation marks
    around the text found within the <code>q tag</code>.
  </li>
</ul>
...
<ul>
  ...
  <li>
    Component SCSS file:<code>quotation.scss</code>
  </li>
  <u>To use CSS include the following files in your implementation</u>
  <li>
    The compiled CSS file from <code>assets/css/style.css</code>
...
<ul>
  <li>
    We can use the <code>small</code> in any component to makes text one font
    size smaller in the HTML document.
  </li>
</ul>
...
<ul>
  ...
  <li>
    Component SCSS file:<code>small.scss</code>
  </li>
  <u>To use CSS include the following files in your implementation</u>
  <li>
    The compiled CSS file from <code>assets/css/style.css</code>
...
<p>
  An unordered list is used if there is no hierarchy required. Unordered lists
  start with a bullet.
</p>
<p>
...
<p>
  An ordered list is used if there is a relation/hierarchy between list items.
  Ordered list items begin with a number generally.
</p>
<p>
...
<p>
  The <code>dl</code> tag defines the description list, the <code>dt</code> tag
  defines the term (name), and the <code>dd</code> tag describes each term.
</p>
...
<ul>
  ...
  <li>
    Component SCSS file: <code>lists.scss</code>
  </li>
  <u>To use CSS include the following files in your implementation</u>
  <li>
    The compiled CSS file from <code>assets/css/style.css</code>
