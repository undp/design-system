...
1. UNDP Logo - Blue [Download](https://github.com/undp/design-system/blob/master/dist/images/undp-logo-blue.svg)

This is the default logo and is used primarily in the header of every page as well as country sites.

<Canvas>
  <Story name="UNDP Logo - Blue" 
    parameters={{ 
...
2. UNDP Logo - White [Download](https://github.com/undp/design-system/blob/master/dist/images/undp-logo-white.svg)

The UNDP white logo is primarily used in the footer of all pages as well as on a dark background.

<Canvas>
  <Story name="UNDP Logo - White" 
    parameters={{ 
...
3. PNUD Logo - Blue [Download](https://github.com/undp/design-system/blob/master/dist/images/pnud-logo-blue.svg)

This is the default PNUD logo and is used primarily in the header of every page as well as country sites. 

<Canvas>
  <Story name="PNUD Logo - Blue" 
    parameters={{ 
      backgrounds: { default: 'white'}, 
      disable: true
  }}>
...
4. PNUD Logo - White [Download](https://github.com/undp/design-system/blob/master/dist/images/pnud-logo-white.svg)
