          ...
          <div className="grid-x grid-margin-x align-content-middle">
            ...
            <div className="cell large-8 small-8 mid-nav">
              <nav className="menu" role="navigation" arialabel="Navigation">
                ...
                <a href="https://develop.design-system.pages.dev/iframe?id=components-navigation-components-main-navigation-country-header--country-header&globals=locale:english&args=&viewMode=story&direction=rtl" className="logo">
