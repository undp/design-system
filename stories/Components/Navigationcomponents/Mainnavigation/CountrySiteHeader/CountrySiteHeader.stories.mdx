...
export const getNavLinks = (locale) => {
  switch (locale) {
    case "english":
      return [
        { label: "Who we are", id: "headerlink1" },
        { label: "What we do", id: "headerlink2" },
        { label: "Our Impact", id: "headerlink3" },
        { label: "Get Involved", id: "headerlink4" },
      ];
    case "arabic":
      return [
        { label: "من نحن", id: "headerlink1" },
        { label: "الذي نفعله", id: "headerlink2" },
        { label: "تأثيرنا", id: "headerlink3" },
        { label: "شارك", id: "headerlink4" },
      ];
    case "burmese":
      return [
        { label: "ငါတို့ဘယ်သူလဲ။", id: "headerlink1" },
        { label: "ငါတို့ဘာလုပ်မလဲ။", id: "headerlink2" },
        { label: "ကျွန်ုပ်တို့၏သက်ရောက်မှု", id: "headerlink3" },
        { label: "ပါဝင်လိုက်ပါ။", id: "headerlink4" },
      ];
    case "japanese":
      return [
        { label: "私たちは誰ですか", id: "headerlink1" },
        { label: "私達がすること", id: "headerlink2" },
        { label: "私たちの影響", id: "headerlink3" },
        { label: "参加する", id: "headerlink4" },
      ];
    default:
      return [
        { label: "Who we are", id: "headerlink1" },
