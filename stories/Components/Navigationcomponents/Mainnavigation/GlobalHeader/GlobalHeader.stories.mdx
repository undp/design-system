...
<style>{`
  .global-header .header{position:absolute;}
  #story--components-navigation-components-main-navigation-global-header--global-header{
    position:relative; 
    height:9rem;
    width:100vw;
  }
...
<Canvas>
<Story name="Global header" parameters={{
    layout: "fullscreen"
  }}>
  {(args, { globals: { locale } }) => {
