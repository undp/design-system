    ...
    <>
      <div className="input-group">
        ...
        <div className={[`input-group__icon ${type}-field ${mode}`].join(' ')}>
          <textarea type={type} id={id} disabled={disabled} required={required} placeholder={placeholder} minlength={minlength} cols={cols} rows={rows} className={['input__controls', `input__controls--${type} ${mode}`].join(' ')}></textarea>
        </div>
