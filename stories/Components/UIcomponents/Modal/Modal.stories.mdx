...
<Canvas>
  <Story name="Modal">
    {(args, { globals: { locale } }) => {
      ...
      return <Modal contenttile={caption.title} contentname={caption.name}  descriptionText={caption.descriptionText} descriptionText2={caption.descriptionText2}  button={caption.btnlabel}  alt={'modal image'} image={img} image2={img2} {...args} content={caption.content}></Modal>;
    }}
  </Story>
</Canvas>
