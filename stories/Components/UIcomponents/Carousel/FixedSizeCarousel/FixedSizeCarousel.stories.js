...
FixedSizeCarouselStory.parameters = {
  docs: {
    description: {
      component: `
...
- If you use fixed image size carousel then include fluid-image-size-carousel.min.css and initialize carousel by calling swiper('.fixed-carousel', '.fixed-carousel\_\_button-wrap'); functions
