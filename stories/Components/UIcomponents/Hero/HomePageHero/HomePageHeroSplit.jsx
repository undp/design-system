...
export const Homepageherosplit = ({ title, content, button, variant, headingSize }) => {
  const validHeadingSizes = ["small", "medium", "large"];
  const headingSizeClass = validHeadingSizes.includes(headingSize) ? headingSize : "";

  return (
    <div className="homepage-hero-tall">
      <div className="grid-x">
        <div className="cell medium-5 medium-offset-1">
          <div className={`homepage-hero-tall-content ${headingSizeClass}`.trim()}>
