...
const Template = (args, { globals: { locale } }) => {
  ...
  return <Homepagehero title={caption.titlename} content={caption.text} button={caption.btnlabel} {...args}></Homepagehero>;
};

export const HomepageHeroStory = Template.bind({});
HomepageHeroStory.args = {
};

// Documentation content
HomepageHeroStory.parameters = {
  docs: {
    description: {
      component: `
...
- https://cdn.jsdelivr.net/npm/@undp/design-system/docs/css/components/homepagehero.min.css
