      ...
      page: () => (
        <>
          ...
          <ul>
            ...
            <li>
              If you want the font size of heading elements to dynamically
              adjust based on the screen size, use the <code>fitHeading</code>{" "}
              function from the <code>fitText.js</code> file.
            </li>
          </ul>
