        ...
        page: () => (
            <>
              ...
              <ul>
                  ...
                  <li>Choose one of the following initialization methods for the expandToSize effect:</li>
              </ul>
              ...
              <ul>
                ...
                <li>Add the required data attributes to your hero element:
                  <code>data-undpds-component="expandToSize" data-selector=".pagehero-full"</code>
                </li>
              ...
              <ul>
                ...
                <li>Call the initialization function directly in your JavaScript:
                  <code>expandToSize('.pagehero-full');</code>
                </li>
              </ul>

              <p>Additional options:</p>
              <ul>
                <li>If you want to add left-right animation, add <code>data-viewport="true"</code> attribute to your HTML element and include <code>viewport.min.js</code> file.</li>
              </ul>
