...
- https://cdn.jsdelivr.net/npm/@undp/design-system/docs/css/components/frosted-background.min.css
- https://cdn.jsdelivr.net/npm/@undp/design-system/docs/css/components/image-caption.min.css
- https://cdn.jsdelivr.net/npm/@undp/design-system/docs/css/components/lightbox.min.css
- https://cdn.jsdelivr.net/npm/@undp/design-system/docs/css/components/lightbox-gallery.min.css
- https://cdn.jsdelivr.net/npm/@undp/design-system/docs/css/components/swiper.min.css

JS:

- https://cdn.jsdelivr.net/npm/@undp/design-system/docs/js/lightbox-gallery.min.js
