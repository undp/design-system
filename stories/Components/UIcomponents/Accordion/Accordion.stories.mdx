...
- [Base layouting CSS](https://cdn.jsdelivr.net/gh/undp/design-system/docs/css/base-minimal.min.css).
- [Copy and add this component CSS in your project](https://cdn.jsdelivr.net/gh/undp/design-system/docs/css/components/accordion.min.css).

#### JS

[Use this JS file in your project ](https://cdn.jsdelivr.net/gh/undp/design-system/docs/js/accordion.min.js)
