  ...
  docs: {
    page: () => (
      <>
        ...
        <ul>
          <li><a href="https://cdn.jsdelivr.net/npm/@undp/design-system/docs/css/base-minimal.min.css">Base layouting CSS</a></li>
          <li><a href="https://cdn.jsdelivr.net/npm/@undp/design-system/docs/css/components/accordion.min.css">Copy and add this component CSS in your project</a></li>
        </ul>
        <h4>JS</h4>
        ...
        <ul>
          <li>Optional <strong>deep linking</strong> - allow users to open a particular accordion panel at page load with hash-appended URL. Configurable by setting data-deep-link=”true”, disabled by default</li>
          <li>Browser history - modifying widget behavior for browser history modification, by default each click replaces current page’s URL, but by using data-update-history=”true” you can instruct browser to insert new entries on every click providing ability to track back the navigation history while clicking Back button.</li>
        </ul>
        <h3>Changelog</h3>
