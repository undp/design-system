...
Template for SDG Page

<Story name="SDG Page" parameters={{
    layout: "fullscreen"
  }}>
  {(args, { globals: { locale } }) => {
...
- Include the common SCSS files like breakpoints, variables, mixin from <code>assets/scss</code>
...
- Include JS Slider library file from <code>assets/js/sdgmodal.js</code>
- The compiled JS file from <code>assets/js/sdgmodal.js</code>
