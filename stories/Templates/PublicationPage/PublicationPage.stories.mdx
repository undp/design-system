...
- https://cdn.jsdelivr.net/gh/undp/design-system/docs/css/components/publication-card.min.css
...
- https://cdn.jsdelivr.net/gh/undp/design-system/docs/css/templates/publication-page.min.css
