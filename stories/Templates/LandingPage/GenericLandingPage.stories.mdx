...
- https://cdn.jsdelivr.net/npm/@undp/design-system/docs/css/templates/generic-landing-page.min.css

#### JS:

- https://cdn.jsdelivr.net/npm/@undp/design-system/docs/js/animation.min.js
- https://cdn.jsdelivr.net/npm/@undp/design-system/docs/js/filter_seach_bar.min.js
