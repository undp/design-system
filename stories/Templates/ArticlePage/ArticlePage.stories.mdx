...
import { getCaptionForLocale as paraLabel } from "../../Atom/BaseTypography/Paragraph/Paragarph.mdx";
...
- https://undp.github.io/design-system/css/components/post-header.min.css
