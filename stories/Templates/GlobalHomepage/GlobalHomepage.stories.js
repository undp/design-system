...
export default {
  ...
  parameters: {
    ...
    <p>The following components are used to create the “Global Homepage” template in the design system:</p>
    <ol>
        <li>Global header</li>
        ...
        <li>Our Expertise - two panels with horizontal slider and tabbed navigation</li>
    ...
    <p>Initialize navigation, language switcher, accordion, statsHover, swiper effect by calling below mentioned functions when visible on screen:</p>
    <ul>
...
GlobalHomepageStory.storyName = "Global homepage";
