...
export const CountryHomepage = ({
    footerData, herotitle, herotext, herobtnlabel, herosubtitle, heroimgsrc, heroimgalt, featureddata, headertext, PagewidecardTag, PagewidecardTitle, PagewidecardParagraph, PagewidecardBtnlabel, StatsSliderData, takeactioncard, whatwedoheader, whatwedodescription, featureddataafterwedo, statHeading, storiesHeading, 
  }) => (
    <> 
