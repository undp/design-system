...
| `--undpds-color-gray-530` | `#84929d` | `--undpds-color-light-green` | `#b8ecb6` |
| `--undpds-color-gray-560` | `#677383` | `--undpds-color-light-pink` | `#ffb4ae` |
| `--undpds-color-azure-600` | `#00c1ff` | `--undpds-color-light-red` | `#ffbcb7` |
| `--undpds-color-blue-600` | `#006eb5` | `--undpds-color-light-yellow` | `#ffe17e` |
| `--undpds-color-gray-600` | `#55606e` | `--undpds-color-red` | `#ee402d` |
...
|----------|-------|----------|-------|----------|-------|
| `--undpds-spacing-01` | `2px` | `--undpds-spacing-012` | `12px` | `--undpds-spacing-060` | `3.75rem` |
| `--undpds-spacing-002` | `2px` | `--undpds-spacing-12` | `96px` | `--undpds-spacing-60` | `3.75rem` |
| `--undpds-spacing-02` | `4px` | `--undpds-spacing-13` | `160px` | `--undpds-spacing-064` | `64px` |
| `--undpds-spacing-03` | `8px` | `--undpds-spacing-016` | `16px` | `--undpds-spacing-070` | `4.375rem` |
| `--undpds-spacing-004` | `4px` | `--undpds-spacing-024` | `24px` | `--undpds-spacing-70` | `4.375rem` |
| `--undpds-spacing-04` | `12px` | `--undpds-spacing-032` | `32px` | `--undpds-spacing-076` | `4.75rem` |
| `--undpds-spacing-05` | `16px` | `--undpds-spacing-036` | `2.25rem` | `--undpds-spacing-76` | `4.75rem` |
| `--undpds-spacing-06` | `24px` | `--undpds-spacing-36` | `2.25rem` | `--undpds-spacing-080` | `80px` |
| `--undpds-spacing-07` | `32px` | `--undpds-spacing-040` | `40px` | `--undpds-spacing-090` | `5.625rem` |
| `--undpds-spacing-008` | `8px` | `--undpds-spacing-044` | `2.75rem` | `--undpds-spacing-90` | `5.625rem` |
| `--undpds-spacing-08` | `40px` | `--undpds-spacing-44` | `2.75rem` | `--undpds-spacing-096` | `96px` |
| `--undpds-spacing-09` | `48px` | `--undpds-spacing-048` | `48px` | `--undpds-spacing-100` | `6.25rem` |
| `--undpds-spacing-10` | `64px` | `--undpds-spacing-050` | `3.125rem` | `--undpds-spacing-160` | `160px` |
| `--undpds-spacing-11` | `80px` | `--undpds-spacing-50` | `3.125rem` | `--undpds-spacing-gutter` | `24px` |
