...
| Property | Value | Property | Value | Property | Value |
|----------|-------|----------|-------|----------|-------|
| `--undpds-font-size-14` | `0.875rem` | `--undpds-font-size-48` | `3rem` | `--undpds-font-size-display-large` | `3.5rem` |
| `--undpds-font-size-16` | `1rem` | `--undpds-font-size-56` | `3.5rem` | `--undpds-font-size-display-xlarge` | `5rem` |
| `--undpds-font-size-20` | `1.25rem` | `--undpds-font-size-64` | `4rem` | `--undpds-font-size-display-xxlarge` | `6.25rem` |
| `--undpds-font-size-24` | `1.5rem` | `--undpds-font-size-72` | `4.5rem` | `--undpds-font-size-heading-large` | `3rem` |
| `--undpds-font-size-25` | `1.5rem` | `--undpds-font-size-80` | `5rem` | `--undpds-font-size-heading-medium` | `2rem` |
| `--undpds-font-size-26` | `1.5rem` | `--undpds-font-size-96` | `6rem` | `--undpds-font-size-heading-small` | `1.5rem` |
| `--undpds-font-size-30` | `1.875rem` | `--undpds-font-size-100` | `6.25rem` | `--undpds-font-size-heading-xlarge` | `4rem` |
| `--undpds-font-size-32` | `2rem` | `--undpds-font-size-body-default` | `1.25rem` | `--undpds-font-size-heading-xsmall` | `1rem` |
| `--undpds-font-size-40` | `2.5rem` | `--undpds-font-size-body-small` | `1rem` | `--undpds-font-size-heading-xxlarge` | `5rem` |
...
| `--undpds-sdg-bright-blue` | `#26bde2` | `--undpds-sdg-hover-navy-blue` | `#a2c2d8` |
| `--undpds-sdg-burgundy-red` | `#a21942` | `--undpds-sdg-hover-orange` | `#d2aa98` |
